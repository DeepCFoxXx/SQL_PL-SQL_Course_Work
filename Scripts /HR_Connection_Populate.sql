--------------------------------------------------------
--  Drop Tables if running script for second time
--  Remove --
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  DEPARTMENTS_SEQ  MINVALUE 1 MAXVALUE 9990 INCREMENT BY 10 START WITH 280;
--------------------------------------------------------
--  DDL for Sequence EMPLOYEES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  EMPLOYEES_SEQ  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 207;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER EMPLOYEES_EMPLOYEE_ID_TRG 
...
/
ALTER TRIGGER EMPLOYEES_EMPLOYEE_ID_TRG ENABLE;
--------------------------------------------------------
